...
#ifdef BUILDING_PANDA_PIRATES
  #define EXPCL_PANDA_PIRATES EXPORT_CLASS
  #define EXPTP_PANDA_PIRATES EXPORT_TEMPL
#else
  #define EXPCL_PANDA_PIRATES IMPORT_CLASS
  #define EXPTP_PANDA_PIRATES IMPORT_TEMPL
#endif
